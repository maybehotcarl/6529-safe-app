...
const USE_CASE_DELEGATION_MANAGER = 17
  ...
  return (
    <div className="p-4 bg-gray-900 rounded-lg border border-gray-700 space-y-4">
      ...
      <p className="text-xs text-gray-400">
        Grant a hot wallet the right to manage delegations on behalf of this Safe (use case 17).
        Once granted, the manager can register or revoke delegations without the Safe needing
        to sign each time.
      </p>
      ...
      {/* Add manager form */}
      <form onSubmit={handleAdd} className="space-y-3 pt-2 border-t border-gray-700">
        <div>
